...
public class ContasReceberBaixarConta extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
                ...
                for (int i = 0; i < temp.size(); i++) {
                    ...
                    if (valTemp > 0) {
                        ...
                        for (int a = 0; a < IdsCR.size(); a++) {
                            ...
                            int valFinRecCli = Integer.parseInt(bd.getValorFinReceberCli(IdsCR.get(a)));
                            ...
                            if (valorRestante > 0) {
                                ...
                                if (valTemp >= valorRestante) {
                                    ...
                                    //
                                    valTemp = 0;
                                    /*String[] sub = {String.valueOf(valorRestante), String.valueOf(valTemp)};
                                    valTemp = Integer.parseInt(String.valueOf(cAux.subitrair(sub)));*/
                                }
    ...
    private void listarFinanceiro() {
        try {
            //
            listaFinanceiroCliente = bd.getFinanceiroClienteRecebidos(Integer.parseInt(codigo_cliente));
            adapter = new FinContasReceberCliAdapter(this, listaFinanceiroCliente);
            rvFinanceiro.setAdapter(adapter);
