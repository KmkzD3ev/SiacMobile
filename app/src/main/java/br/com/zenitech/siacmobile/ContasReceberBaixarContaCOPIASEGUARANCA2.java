...
public class ContasReceberBaixarContaCOPIASEGUARANCA2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spFormasPagamentoCliente.setOnItemSelectedListener(ContasReceberBaixarContaCOPIASEGUARANCA2.this);
    }
    ...
    private void _finalizarBaixaContaReceber() {
        ...
        if (totalItemFin == 0) {
            ...
            try {
                ...
                Log.e("ErrorCR", String.valueOf(temp.size()));
                ...
                for (int i = 0; i < temp.size(); i++) {
                    ...
                    TvalTemp = temp.get(i).getValor();
                    Log.e("ErrorCR", String.valueOf(TvalTemp));
                    // CONVERTE PARA INTEIRO PARA COMPARAÇÃO
                    valTemp = Integer.parseInt(cAux.soNumeros(TvalTemp));
                    Log.e("ErrorCR", String.valueOf(valTemp));
                    ...
                    if (valTemp > 0) {
                        ...
                        for (int a = 0; a < IdsCR.size(); a++) {
                            ...
                            Log.e("ErrorCR", String.valueOf(idContaReceber));
                            ...
                            String TvalFinRecCli = bd.getValorFinReceberCli(idContaReceber);
                            ...
                            String TtotRecebido = bd.getTotalRecebido(idContaReceber);

                            // SUBTRAI O VALOR DO FINANCEIRO COM O VALOR RECEBIDO
                            String[] v = {String.valueOf(TvalFinRecCli), String.valueOf(TtotRecebido)};
                            ...
                            //
                            showLOG("ContasReceber", "valTemp = " + valTemp + " | ID " + idContaReceber);
                            ...
                            if (valorRestante > 0) {
                                ...
                                if (valSalvar > 0) {
                                    //Toast.makeText(this, TvalorSalvar, Toast.LENGTH_SHORT).show();
                                    ...
                                    String formaPagamento = temp.get(i).getId_forma_pagamento();
                                    ...
                                    bd.addFinanceiroRecebidos(new FinanceiroVendasDomain(
                                            ...
                                            "" + numDocumento,
                                            "" + venDocumento,
                                            "" + TvalFinRecCli,//cAux.converterValores(txtValorFormaPagamento.getText().toString()),
                                            "0",
                                            "" + TvalorSalvar,
                                            "0",
                                            "0",
